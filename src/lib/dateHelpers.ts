// =============================================================
// Pure date helpers — canonical shared location
// =============================================================
// Local-timezone everywhere. toISOString() would convert to UTC and
// shift days across boundaries (the Phase 2.9 bug class: trips
// vanishing from the "tomorrow" bucket after ~7pm CDT, stats
// miscategorization, home feed daysAway off-by-one).
//
// Lifted from src/components/wizard/quick-trip/dateHelpers.ts so
// non-wizard callers don't reach into the wizard subtree.
// =============================================================
